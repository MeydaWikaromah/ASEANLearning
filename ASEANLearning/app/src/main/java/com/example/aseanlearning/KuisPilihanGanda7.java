...
public class KuisPilihanGanda7 extends AppCompatActivity {
    ...
    SoalPilihanGanda7 soalPG = new SoalPilihanGanda7();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda7);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda7.this, HasilSkor1.class);
