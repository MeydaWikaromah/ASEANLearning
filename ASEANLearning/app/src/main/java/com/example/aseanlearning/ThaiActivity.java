...
public class ThaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan4);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ThaiActivity.this, KuisPilihanGanda4.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi4").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
