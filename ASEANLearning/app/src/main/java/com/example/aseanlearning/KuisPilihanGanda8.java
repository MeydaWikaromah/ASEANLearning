...
public class KuisPilihanGanda8 extends AppCompatActivity {
    ...
    SoalPilihanGanda8 soalPG = new SoalPilihanGanda8();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda8);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda8.this, HasilSkor1.class);
