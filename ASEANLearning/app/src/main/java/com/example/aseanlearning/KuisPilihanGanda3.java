...
public class KuisPilihanGanda3 extends AppCompatActivity {
    ...
    SoalPilihanGanda3 soalPG = new SoalPilihanGanda3();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda3);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda3.this, HasilSkor1.class);
