...
public class filiphinaActivity extends AppCompatActivity {
    Button btnPilGan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filiphina);
        ...
        btnPilGan = findViewById(R.id.PilGan10);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(filiphinaActivity.this, KuisPilihanGanda10.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi10").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
