...
public class SingapuraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan3);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SingapuraActivity.this, KuisPilihanGanda3.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
