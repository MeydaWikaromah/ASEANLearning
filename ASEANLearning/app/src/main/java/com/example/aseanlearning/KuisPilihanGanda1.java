...
public class KuisPilihanGanda1 extends AppCompatActivity {
    ...
    SoalPilihanGanda1 soalPG = new SoalPilihanGanda1();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda1);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda1.this, HasilSkor1.class);
