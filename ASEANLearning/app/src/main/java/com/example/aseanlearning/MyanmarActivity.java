...
public class MyanmarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan9);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MyanmarActivity.this, KuisPilihanGanda9.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi8").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
