...
public class KuisPilihanGanda6 extends AppCompatActivity {
    ...
    SoalPilihanGanda6 soalPG = new SoalPilihanGanda6();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda6);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda6.this, HasilSkor1.class);
