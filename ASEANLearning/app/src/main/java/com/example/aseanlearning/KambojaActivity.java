...
public class KambojaActivity extends AppCompatActivity {
    Button btnPilGan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan7);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(KambojaActivity.this, KuisPilihanGanda7.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi9").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
