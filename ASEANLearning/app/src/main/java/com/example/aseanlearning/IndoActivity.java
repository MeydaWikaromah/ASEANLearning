...
public class IndoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan1);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(IndoActivity.this, KuisPilihanGanda1.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi1").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
