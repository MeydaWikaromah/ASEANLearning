...
public class KuisPilihanGanda10 extends AppCompatActivity {
    ...
    SoalPilihanGanda10 soalPG = new SoalPilihanGanda10();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda10);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda10.this, HasilSkor1.class);
