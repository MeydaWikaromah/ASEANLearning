...
public class KuisPilihanGanda5 extends AppCompatActivity {
    ...
    SoalPilihanGanda5 soalPG = new SoalPilihanGanda5();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda5);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda5.this, HasilSkor1.class);
