...
public class KuisPilihanGanda9 extends AppCompatActivity {
    ...
    SoalPilihanGanda9 soalPG = new SoalPilihanGanda9();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda9);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda9.this, HasilSkor1.class);
