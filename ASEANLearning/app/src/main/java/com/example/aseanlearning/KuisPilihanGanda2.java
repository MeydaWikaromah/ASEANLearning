...
public class KuisPilihanGanda2 extends AppCompatActivity {
    ...
    SoalPilihanGanda2 soalPG = new SoalPilihanGanda2();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis_pilihan_ganda2);
    ...
    public void setKonten(){
        ...
        if(x >= arr){
            ...
            Intent i = new Intent(KuisPilihanGanda2.this, HasilSkor1.class);
