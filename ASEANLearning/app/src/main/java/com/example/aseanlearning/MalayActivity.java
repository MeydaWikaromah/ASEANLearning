...
public class MalayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPilGan = findViewById(R.id.PilGan2);

        btnPilGan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MalayActivity.this, KuisPilihanGanda2.class);
                startActivity(i);
            }
        });
        ...
        mDatabase.child("materi2").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
